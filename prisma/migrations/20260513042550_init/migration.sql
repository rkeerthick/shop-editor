...
-- AddForeignKey
ALTER TABLE "StorefrontPage" ADD CONSTRAINT "StorefrontPage_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StorefrontBlock" ADD CONSTRAINT "StorefrontBlock_pageId_fkey" FOREIGN KEY ("pageId") REFERENCES "StorefrontPage"("id") ON DELETE CASCADE ON UPDATE CASCADE;
